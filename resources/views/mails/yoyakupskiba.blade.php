                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <h2>{{ $mailData['data']->your_name }} 様より、</h2>
                          <h2>以下の予約が入りました。</h2>
                        @else
                        <h2>{{ $mailData['data']->your_name }} 様の予約が</h2>
                        <h2>以下のように変更されました。</h2>
                        @endif
                      </td>
                      @php
                        ...
                        <td>
                          <table class="info-table">
                            <tr>
                              <td>予約日時</td>
                              <td>
                                {{ $mailData['data'] ->yoyakujikan->yoyakubi->title }} {{ $mailData['data'] ->yoyakujikan->start_time_only }}
                              </td>
                            </tr>
                            <tr>
                              <td>お名前</td>
